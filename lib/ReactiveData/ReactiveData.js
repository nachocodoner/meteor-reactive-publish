...
// Export variable for client-side _subscriptionData collection
...
if (Meteor.isClient) {
  ...
  Connection.prototype._initializeSubscriptionData = function () {
    ...
    // Expose the _subscriptionData collection via module export
    SubscriptionData = this._subscriptionData;
