...
// Export the functions - this is the only export statement in the file
export { run, getStore };
...
// The functions are already exported at the top of the file when the API is already installed
