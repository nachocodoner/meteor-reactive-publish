...
import { ReactiveVarAsync } from './AsyncReactive/ReactiveVarAsync';
...
['STRING' /* 'MONGO' */].forEach((idGeneration) => {
  ...
  if (Meteor.isClient) {
    Tinytest.addAsync(
      `PublishReactive basic (${idGeneration}) - users-posts`,
      (test, done) => {
    ...
    Tinytest.addAsync(
      `PublishReactive basic (${idGeneration}) - users-posts-foreach`,
      (test, done) => {
    ...
    Tinytest.addAsync(
      `PublishReactive basic (${idGeneration}) - users-posts-autorun`,
      (test, done) => {
    ...
    Tinytest.addAsync(
      `PublishReactive basic (${idGeneration}) - users-posts-method`,
      (test, done) => {
    ...
    Tinytest.addAsync(
      `PublishReactive basic (${idGeneration}) - users-posts-reactive`,
      (test, done) => {
  ...
  if (Meteor.isClient) {
    Tinytest.addAsync(
      `PublishReactive unsubscribing (${idGeneration}) - users-posts`,
      (test, done) => {
        runSteps(unsubscribingSteps('users-posts', test), test, done);
      }
    );
    Tinytest.addAsync(
      `PublishReactive unsubscribing (${idGeneration}) - users-posts-foreach`,
      (test, done) => {
    ...
    Tinytest.addAsync(
      `PublishReactive unsubscribing (${idGeneration}) - users-posts-autorun`,
      (test, done) => {
    ...
    Tinytest.addAsync(
      `PublishReactive unsubscribing (${idGeneration}) - users-posts-method`,
      (test, done) => {
    ...
    Tinytest.addAsync(
      `PublishReactive unsubscribing (${idGeneration}) - users-posts-reactive`,
      (test, done) => {
  ...
  if (Meteor.isClient) {
    Tinytest.addAsync(
      `PublishReactive remove field (${idGeneration}) - users-posts`,
      (test, done) => {
    ...
    Tinytest.addAsync(
      `PublishReactive remove field (${idGeneration}) - users-posts-foreach`,
      (test, done) => {
    ...
    Tinytest.addAsync(
      `PublishReactive remove field (${idGeneration}) - users-posts-autorun`,
      (test, done) => {
    ...
    Tinytest.addAsync(
      `PublishReactive remove field (${idGeneration}) - users-posts-method`,
      (test, done) => {
  ...
  if (Meteor.isClient) {
    Tinytest.addAsync(
      `PublishReactive multiple (${idGeneration}) - users-posts-and-addresses`,
      (test, done) => {
    ...
    Tinytest.addAsync(
      `PublishReactive multiple (${idGeneration}) - users-posts-and-addresses-together`,
      (test, done) => {
        runSteps(
  ...
  if (Meteor.isClient) {
    ...
    Tinytest.addAsync(
      `PublishReactive reactive time (${idGeneration}) - recent-posts`,
      (test, done) => {
        const steps = [
          async function (next) {
  ...
  if (Meteor.isClient) {
    ...
    Tinytest.addAsync(
      `PublishReactive multiple cursors (${idGeneration}) - multiple-cursors`,
      (test, done) => {
  ...
  if (Meteor.isClient) {
    Tinytest.addAsync(
      `PublishReactive local collection (${idGeneration}) - localCollection`,
      (test, done) => {
  ...
  if (Meteor.isClient) {
    Tinytest.addAsync(
      `PublishReactive unblocked (${idGeneration}) - runOnServer`,
      (test, done) => {
  ...
  if (Meteor.isClient) {
    Tinytest.addAsync(
      `PublishReactive error (${idGeneration}) - initial error`,
      (test, done) => {
    ...
    Tinytest.addAsync(
      `PublishReactive error (${idGeneration}) - rereun error`,
      (test, done) => {
        let isReady = false;
  ...
  if (Meteor.isClient) {
    Tinytest.addAsync(
      `PublishReactive cleanup (${idGeneration}) - documents and oldDocuments cleanup`,
      async (test, done) => {
        try {
