...
Tinytest.addAsync(
  'AsyncTracker - AsyncTracker - autorun, invalidate, stop',
  async function (test) {
    let runCount = 0;
...
Tinytest.addAsync(
  'AsyncTracker - AsyncTracker - beforeRun and afterRun',
  async function (test) {
    let runCount = 0;
...
Tinytest.addAsync('AsyncTracker - AsyncTracker - flush', async function (test) {
  let runCount = 0;
...
Tinytest.addAsync(
  'AsyncTracker - AsyncTracker - nested autoruns',
  async function (test) {
