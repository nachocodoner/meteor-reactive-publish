    ...
    return [
      ...
      async function (next) {
        ...
        try {
          ...
          test.isTrue(this.initialComputationState.cursorCacheSize === 1, 'Cursor cache should have one entry');
      ...
      async function (next) {
        ...
        try {
          ...
          test.isTrue(this.initialComputationState.exists, 'Computation should exist');
          test.isFalse(this.initialComputationState.stopped, 'Computation should not be stopped initially');
          test.isTrue(this.initialComputationState.cursorCacheSize === 1, 'Cursor cache should have kept in one entry as same cursor');
