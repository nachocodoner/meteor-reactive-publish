...
cp lib/ReactiveMongo/*.js "$PACKAGE_PATH/lib/ReactiveData/"
...
echo "Adding protocolTimeout: 300_000, and additional args to puppeteer.launch in puppeteer_runner.js"
sed -i 's/headless: "new",/headless: true,\n    protocolTimeout: 300_000,/' meteor-core/packages/test-in-console/puppeteer_runner.js
sed -i "s/'--disable-web-security',/'--disable-web-security',/" meteor-core/packages/test-in-console/puppeteer_runner.js
